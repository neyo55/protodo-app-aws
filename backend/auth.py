    ...
    if 'avatar' in request.files:
        ...
        if file and allowed_file(file.filename):
            ...
            if not all([s3_bucket, s3_region]):
                return jsonify({"message": "Bucket name or region missing"}), 500

            # INITIALIZE BOTO3 (No hardcoded keys needed, it uses the IAM Role automatically)
            ...
            try:
                ...
                # Save the FULL Public URL to the Database
